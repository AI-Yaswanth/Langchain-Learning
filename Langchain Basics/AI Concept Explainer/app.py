...
st.write("This app explains the concept of AI in a way that is easy to understand.")
    ...
    system_prompt = ChatPromptTemplate.from_messages(
        [
            (
                ...
                **LAYMAN EXPLANATION:**
                [2-3 sentences in plain English anyone can understand. Use an analogy if helpful.]

                **TECHNICAL EXPLANATION:**
                [2-3 sentences using proper AI/ML terminology, accurate and precise.]

                **REAL-WORLD EXAMPLE:**
                [1-2 sentences showing this concept in action in the real world.]

                **INTERVIEW QUESTION:**
                [A realistic technical interview question about this topic.]

                **SHORT ANSWER:**
                [A single crisp sentence answering the interview question above.]
                """
            ),
            (
                "user",
